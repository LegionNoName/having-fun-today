...
function CrimeSpreeTweakData:init_missions(tweak_data)
	local debug_short_add = 50
	local debug_med_add = 70
	local debug_long_add = 100
	self.missions = {
		{
			{
...
function CrimeSpreeTweakData:init_modifiers(tweak_data)
	...
	self.max_modifiers_displayed = 3000
